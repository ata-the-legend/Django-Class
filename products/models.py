...
class Product(models.Model):
    name = models.CharField(verbose_name= _('Persion Name'), max_length=200)
...
class Image(models.Model):
    name = models.CharField(_("Image"), max_length=50)
...
class ProductOption(models.Model):
    ...
    name = models.CharField(_("Atrribute"), max_length=200)
...
class ProductPrice(models.Model):
    ...
    def __str__(self):
        return f'{self.product.en_name} price: {self.price}'
